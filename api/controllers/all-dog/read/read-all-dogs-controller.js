module.exports = {
  ...
  friendlyName: 'All Dog Forms Controller',

  // Descrição do controlador
  description: 'Controller for handling all dog forms data.',
  ...
  fn: async function (inputs, exits) {
    try {
      ...
      const id = inputs.id;
      // Usa o helper 'read' para ler os registros no modelo 'all_dog'
      ...
      return exits.serverError({ error: 'Error retrieving all_dog(s): ' + error.message });
    }
  }
};
